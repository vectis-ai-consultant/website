    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f2f5fb', color: '#1a1740' }}>
        ...
        <div className="story" id="story">
          ...
          <section id="orbit" className="orbit-stage">
            <div className="act-sticky">
              <div className="act-copy orbit-copy">
                <span className="act-num">02 — WHAT IT RUNS ON</span>
                <h2>The models and tools<br /><em>you already use.</em></h2>
                <p>We build on OpenAI, Claude and Gemini, wire them together with the automation layer underneath, and connect the channels your customers actually arrive through.</p>
              </div>
            </div>
          </section>
          ...
          <section id="how" data-reveal="1" style={{ padding: '0 56px 40px', maxWidth: '1200px', margin: '0 auto', scrollMarginTop: '110px' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: '28px', marginBottom: '28px' }}>
              ...
              <p style={{ fontSize: '13px', letterSpacing: '.18em', color: '#7b83a8', margin: '0 0 6px' }}>HOW IT WORKS</p>
            </div>
            <h2 style={{ fontSize: '36px', fontWeight: '700', letterSpacing: '-.02em', lineHeight: '1.15', margin: '0 0 14px', maxWidth: '640px', textWrap: 'pretty' }}>We tailor the solution to your current workflow.</h2>
            <p style={{ fontSize: '17px', color: '#4a4f70', lineHeight: '1.65', margin: '0 0 40px', maxWidth: '560px', textWrap: 'pretty' }}>From the CRM your team lives in, down to the model layer underneath, we build AI into the systems you already operate. No migration, no new logins. Works on day 1</p>
          ...
          <section id="services" data-reveal="1" style={{ padding: '60px 56px 40px', maxWidth: '1200px', margin: '0 auto', scrollMarginTop: '110px' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: '28px', marginBottom: '28px' }}>
              <span data-num="1" style={{ fontSize: '120px', fontWeight: '300', lineHeight: '.8', color: '#dbe3f3', fontFamily: 'Georgia,serif', letterSpacing: '-.02em' }}>02</span>
          ...
          <section id="process" data-reveal="1" style={{ padding: '40px 56px 100px', maxWidth: '1200px', margin: '0 auto', scrollMarginTop: '110px' }}>
            <div style={{ display: 'flex', alignItems: 'flex-end', gap: '28px', marginBottom: '28px' }}>
              ...
              <span style={{ fontSize: '13px', letterSpacing: '.18em', color: '#1a1740', fontWeight: '600', paddingBottom: '6px' }}>HOW WE WORK</span>
            </div>
            <h2 id="processHead" style={{ fontSize: '52px', fontWeight: '700', letterSpacing: '-.025em', lineHeight: '1.08', margin: '0 0 96px', maxWidth: '760px', textWrap: 'pretty' }}>Four steps, from first call to a system that runs itself.</h2>
            <div id="processGrid" data-stagger="1" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '40px' }}>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0', marginBottom: '44px' }}>
                    <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: '#3a4fae', flexShrink: '0' }}></div>
                    <div data-line="1" style={{ flex: '1', height: '1px', background: '#cbcdd8' }}></div>
                  </div>
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#1a1740', fontWeight: '600', marginBottom: '22px' }}>STEP ONE</span>
                  <h4 style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-.02em', margin: '0 0 10px' }}>Discovery</h4>
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#3a4fae', fontWeight: '600', marginBottom: '26px' }}>30–60 MIN</span>
                  <p style={{ fontSize: '15px', color: '#343061', lineHeight: '1.75', margin: '0' }}>We learn your business, your bottlenecks, and what you have already tried.</p>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0', marginBottom: '44px' }}>
                    <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: '#3a4fae', flexShrink: '0' }}></div>
                  ...
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#1a1740', fontWeight: '600', marginBottom: '22px' }}>STEP TWO</span>
                  <h4 style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-.02em', margin: '0 0 10px' }}>Plan</h4>
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#3a4fae', fontWeight: '600', marginBottom: '26px' }}>1 WEEK</span>
                  <p style={{ fontSize: '15px', color: '#343061', lineHeight: '1.75', margin: '0' }}>You see exactly what the build looks like — architecture, milestones, and what success means — and we shape the plan together.</p>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0', marginBottom: '44px' }}>
                    <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: '#3a4fae', flexShrink: '0' }}></div>
                  ...
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#1a1740', fontWeight: '600', marginBottom: '22px' }}>STEP THREE</span>
                  <h4 style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-.02em', margin: '0 0 10px' }}>Trial run</h4>
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#3a4fae', fontWeight: '600', marginBottom: '26px' }}>1–2 WEEKS</span>
                  <p style={{ fontSize: '15px', color: '#343061', lineHeight: '1.75', margin: '0' }}>A small scoped build first. Real results in your own workflow before you commit to the full project.</p>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0', marginBottom: '44px' }}>
                    <div style={{ width: '14px', height: '14px', borderRadius: '50%', background: '#3a4fae', flexShrink: '0' }}></div>
                  ...
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#1a1740', fontWeight: '600', marginBottom: '22px' }}>STEP FOUR</span>
                  <h4 style={{ fontSize: '32px', fontWeight: '700', letterSpacing: '-.02em', margin: '0 0 10px' }}>Build &amp; own</h4>
                  <span style={{ fontSize: '12px', letterSpacing: '.16em', color: '#3a4fae', fontWeight: '600', marginBottom: '26px' }}>2–6 WEEKS</span>
                  <p style={{ fontSize: '15px', color: '#343061', lineHeight: '1.75', margin: '0' }}>The complete system, delivered with documentation and a walkthrough so your team owns it. 30 days of support after handoff.</p>
                </div>
            </div>
            <div id="ctaBanner" data-reveal="1" style={{ marginTop: '96px', background: '#d3d7e9', borderRadius: '16px', padding: '40px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '40px' }}>
              <div>
